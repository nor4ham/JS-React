...
An easy way to start React projects is to use a Terminal program called `npx create-react-app hello_world`. You'll have to give your new app a name; we're calling the example app "hello_world", since that'll be our first project. This excellent tool, created by Facebook, will help you set up a bare-bones React app instantly. We can simply install the package and start coding.


Once it's installed, a new directory named `hello_world` is created to store your app, `cd` to the folder. 
